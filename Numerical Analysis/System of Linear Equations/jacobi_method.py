...
def jacobi_iteration(current_guesses, previous_guesses, epsilon):
    is_satisfied = False
    iter_count = 0
    ...
    while not is_satisfied:
        for unknown in previous_guesses:
            ...
            #calculating new guess for unknown
...
jacobi_iteration(current_guesses, previous_guesses, epsilon)
